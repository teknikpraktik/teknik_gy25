...
concepts_used: ["teknik", "tekniskt problem", "krav", "funktion", "valkarta"]
figures: ["fig-2.2.5-a"]
prerequisites: ["2.2.1"]
---
...
## Den fjärde strategin, utanför kartan

De tre strategierna i valkartan (avsnitt 2.2.1 till 2.2.4) förutsätter alla att problemet går att greppa i sin helhet, så att frågorna om kostnad och kunskapsläge går att ställa. Ett sammansatt problem som Husqvarnas är för stort för det: det svarar inte på "vad kostar ett misslyckat försök" utan på en helt annan fråga, är problemet över huvud taget möjligt att överblicka. Ett sådant problem bryts ned i **delproblem**: mindre problem som kan formuleras, lösas och testas var för sig, innan valkartan används på var och en av delarna. I praktiken är det ofta den här frågan man ställer först, även om den kommer sist i den här modulen.
...
2. Varför ligger den här strategin utanför valkartan, till skillnad från de tre andra?
