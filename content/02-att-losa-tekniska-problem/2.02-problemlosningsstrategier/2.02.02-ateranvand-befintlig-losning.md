...
Att uppfinna på nytt kostar tid, pengar och risk, utan att nödvändigtvis ge ett bättre resultat än det som redan är beprövat. Strategin att återanvända en befintlig lösning gäller så fort problemet är välkänt, oavsett vad ett misslyckat försök skulle kosta: när svaret redan finns är det ingen mening att experimentera fram det på nytt. Det är därför återanvänd befintlig lösning fyller hela den välkända kolumnen på valkartan, oavsett rad. Insatsen ligger i stället i att känna igen att en känd lösning passar, och i att anpassa den till det nya sammanhanget, som när kardborrens krokar blev ett textilt band.
