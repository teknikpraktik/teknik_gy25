...
1. Vad är ett behov, enligt texten?
2. Vad är ett tekniskt problem, enligt texten?
3. Beskriv kedjan mellan behov, problem och lösning med egna ord.
4. Varför har ett tekniskt problem nästan aldrig bara ett rätt svar, till skillnad från en matematikuppgift?
5. Vad kännetecknar ett väl formulerat problem, enligt sista stycket?
