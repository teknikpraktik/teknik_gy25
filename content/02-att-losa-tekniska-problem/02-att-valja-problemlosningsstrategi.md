...
Att pröva sig fram avfärdas ibland som fusk, som om bara beräkning vore riktig ingenjörskonst. Det stämmer inte. Strategierna är likvärdiga verktyg, och rätt val avgörs av hur väl förstått problemet är och vad ett misslyckande kostar, inte av vilket som ser mest vetenskapligt ut. Det som skiljer ingenjören från gissaren är motiveringen, alltså att kunna säga varför problemet bedöms som det gör och vad som skulle få bedömningen att ändras.
...
Nedbrytningens risk sitter i skarvarna. År 1999 förlorade NASA rymdsonden Mars Climate Orbiter, sedan ett team räknat i engelska kraftenheter och ett annat i newton. Dellösningarna möttes och styrde tillsammans in sonden för lågt i Mars atmosfär. Båda delarna fungerade, men kopplingen mellan dem gjorde det inte. Den som bryter ned ett problem måste därför bestämma hur delarna ska hänga ihop och i vilka enheter, och testa även skarvarna, inte bara delarna.
...
En schweizisk ingenjör undersökte kardborrar som fastnat i hundens päls efter en jakttur, såg krokarna i mikroskop och tog patent på kardborrebandet 1955. Naturen hade redan löst ett [[begrepp:tekniskt problem]], att ett föremål ska sitta fast men gå att lossa igen. Hans insats var att känna igen lösningen och flytta den till tyg och plast, en av teknikens äldsta tricks.
...
Ett misslyckat försök hade kostat tre liv, och ingen visste i förväg exakt hur adaptern skulle behöva se ut. Det är precis den kombinationen, dyrt att misslyckas och dåligt förstått i förväg, som kräver den här strategin med analys, beräkning och kontrollerade tester innan lösningen genomförs i skarpt läge.
...
2. **Fem försök och en slutsats.** Genomför ett eget pröva-och-förbättra-arbete på ett litet konstruktionsproblem som läraren anger eller som du väljer själv, till exempel en pappersremsa som ska bära en mynthög, ett pappersflygplan som ska flyga så långt som möjligt eller en förpackning som ska skydda ett rått ägg vid ett fall. Genomför minst fem försök och för protokoll över vad du ändrade från förra försöket, vad som hände och vilken slutsats du drog. Redovisa protokollet som en tabell, och visa i en avslutande kommentar hur varje försök byggde på det föregående i stället för att upprepa det.
...
4. **Från behov till vald strategi.** Välj ett sammansatt tekniskt problem ur vardagen, till exempel en odlingslåda som ska vattna sig själv under sommarlovet, ett cykelställ som skyddar cyklarna mot väder och stöld, eller ett eget förslag som läraren godkänner. Den här övningen följer problemet hela vägen från behov till valda strategier och kräver stoff från kapitlets båda avsnitt. Formulera först problemet med funktion, minst tre prövbara krav och minst två begränsningar, utan att bygga in en lösning. Bryt sedan ned det sammansatta problemet i delproblem och rita nedbrytningen som ett träd, med minst ett delproblem nedbrutet i ytterligare en nivå, och markera skarvarna där delarna måste passa ihop och vad de måste komma överens om. Bedöm till sist varje delproblem med de tre frågorna, alltså om det går att överblicka, hur väl förstått det är och vad ett misslyckat försök kostar, och välj och motivera en problemlösningsstrategi för var och en. Redovisa hela vägen från problemformulering till valda strategier, och ange för minst ett delproblem vad som skulle få dig att byta strategi.
