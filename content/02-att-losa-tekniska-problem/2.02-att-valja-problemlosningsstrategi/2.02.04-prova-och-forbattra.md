...
5. En cykeltillverkare funderar på att testa en ny däckblandning genom att låta hundra kunder cykla på den i sex månader, i stället för att beräkna slitaget i förväg. Passar pröva och förbättra här? Motivera utifrån hur väl förstått problemet är och vad ett misslyckande skulle kosta.
