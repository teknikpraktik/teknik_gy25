...
Den första frågan kommer före de andra två: går problemet att greppa i sin helhet, eller är det för stort och sammansatt för att överblickas på en gång? Ett problem som inte går att överblicka måste delas upp i mindre delar innan någon strategi väljs för dem, ett eget avsnitt längre fram tar upp hur. Bara ett problem som går att greppa kan bedömas vidare med de två återstående frågorna.
