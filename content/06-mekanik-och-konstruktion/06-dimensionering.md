...
Gångbron visar varför den nyttiga lasten måste bestämmas för sig och inte gissas ur ett enskilt fall. Bron är 6,0 m lång och 1,5 m bred, alltså 9,0 m² gångbana, och egentyngden är 3600 N. Enstaka cyklister, som tidigare avsnitt räknat med, väger några hundra newton. Men en gångbro ska klara att vara full av folk, och för gångtrafik räknar man i Sverige normalt med 5 kN per kvadratmeter gångbana. Full last blir då

9,0 · 5000 = 45 000 N

alltså drygt tolv gånger brons egentyngd, och femtio gånger den enskilda cyklist bron dimensioneras för att klara utan att någon reflekterar över saken. En konstruktion räknas därför alltid mot flera belastningsfall, och det är sällan det vardagliga fallet som blir avgörande.
...
Beräkningen ovan är alltså ett steg i en betydligt längre process. En verklig dimensionering väger dessutom in kombinationer av flera samtidiga laster, stabilitet mot knäckning och de standarder och föreskrifter som gäller för det som byggs, och där tar listan inte slut. Kapitlet behandlar en liten men central del av den kedjan: sambandet mellan last, tvärsnitt, material och marginal.
...
1. **Marginalen inräknad.** Ett konstruktionsstål har sträckgränsen 275 N/mm². Beräkna den tillåtna spänningen med säkerhetsfaktorn 2,5.
2. **Från last till area.** En dragstång ska klara dragkraften 30 000 N med den tillåtna spänningen 150 N/mm². Beräkna den tvärsnittsarea stången minst måste ha.
3. **Tillbaka till diametern.** Beräkna diametern på en rund stång med tvärsnittsarean 300 mm².
4. **Svaret som inte stämmer.** En beräkning av ett dragstags tvärsnittsarea ger svaret 0,02 mm² för ett stag som ska bära flera ton. Förklara varför svaret bör ifrågasättas, och vad som troligen har gått fel. Gör en överslagsräkning som visar ungefär vilken area som borde ha kommit ut, om lasten är 40 000 N och den tillåtna spänningen 120 N/mm².
5. **Närmast större dimension.** En lyftögla i en verkstadstravers ska bära dragkraften 18 000 N. Materialet har sträckgränsen 355 N/mm², och säkerhetsfaktorn 3 ska användas. Beräkna den tillåtna spänningen, den minsta tvärsnittsarean och den teoretiska minsta diametern. Välj därefter närmast större standarddimension bland 12, 16, 20 och 25 mm, och kontrollera vilken spänning den valda dimensionen faktiskt ger. Kontrollera enheterna genom hela beräkningen, bedöm om den valda dimensionen verkar rimlig för uppgiften, och ange slutligen tre förhållanden som den här förenklade beräkningen inte tar hänsyn till men som skulle påverka en verklig lyftögla.
6. **Dimensionera en egen hylla.** Bestäm vad en ny hylla hemma hos dig skulle bära, genom att väga eller uppskatta det du faktiskt vill ställa på den. Mät var hyllan skulle sitta och hur långt det är mellan tänkbara fästen. Välj en säkerhetsfaktor och motivera valet utifrån vad hyllan ska bära och vad som händer om den ger vika. Beräkna vilken last varje fäste behöver klara. Slå upp den angivna maxlasten för en hyllkonsol i en butik eller på nätet och avgör om den räcker, med din säkerhetsfaktor inräknad. Redovisa mätningar, antaganden och beräkning i en kort sammanställning. Avsluta med om du skulle bygga hyllan som tänkt eller ändra något, och varför.
