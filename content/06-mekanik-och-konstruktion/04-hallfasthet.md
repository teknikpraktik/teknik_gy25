...
*Vridning*, med den tekniska termen torsion, är det tillstånd som uppstår i en detalj när ett moment vrider den kring dess egen längdaxel. Det moment som verkar är belastningen, och det kallas ett vridmoment. Vridningen är den verkan belastningen får: materialet vrids, och tvärsnitten förskjuts något i förhållande till varandra längs axeln. Ett vridmoment är alltså orsaken och vridningen är följden, precis som en dragkraft är orsaken och töjningen följden. En skruvmejsel som drar åt en skruv och en drivaxel som överför kraft från en motor till ett hjul är båda belastade av vridmoment och befinner sig båda i vridning.
...
6. **Vad märkningen lovar.** Leta upp en lastbärande detalj med angiven maxlast, till exempel en karbinhake, ett spännband, en hyllkonsol, en lyftögla eller en vajerklämma. Notera den angivna maxlasten och mät detaljens smalaste tvärsnitt. Beräkna tvärsnittsarean och den spänning som uppstår vid den angivna maxlasten. Slå upp sträckgränsen för ett vanligt konstruktionsstål och jämför. Bedöm hur långt under sträckgränsen tillverkaren lagt sin angivna maxlast, och ange minst två skäl till att den marginalen behövs.
