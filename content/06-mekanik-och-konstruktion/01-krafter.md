...
Mellan två ytor som pressas mot varandra uppstår dessutom en *friktionskraft*, riktad längs kontaktytan. Den motverkar rörelsen, eller tendensen till rörelse, mellan ytorna. I en konstruktion är friktion sällan något som bara bromsar. Ofta är det tvärtom friktionen som håller ihop bygget. Ett skruvförband som klämmer samman två plåtar bär last genom friktionen mellan plåtarna, inte genom att skruven skjuvas, och ett tungt fundament hålls kvar mot marken av friktionen mot underlaget när en vågrät kraft försöker skjuta det åt sidan. En konstruktör behöver därför lika ofta se till att friktionen räcker till som att den hålls nere.
...
7. **Krafterna i din ryggsäck.** Väg din ryggsäck fullpackad, till exempel på en badrumsvåg, och räkna om massan till tyngdkraft. Frilägg sedan ryggsäcken, alltså rita den lösgjord från dig och från allt annat. Rita in tyngdkraften nedåt och den kraft axelbandet drar med uppåt, för det fall att ryggsäcken bärs i ett enda band. Gör därefter om friläggningen för det fall att båda banden används, med två bandkrafter uppåt. Ange storleken på varje bandkraft i båda fallen och skriv ut vad som måste gälla mellan krafterna för att ryggsäcken ska hänga stilla. Jämför de två diagrammen och bedöm vad skillnaden betyder för den axel som bär.
