...
7. **Handtaget du använder.** Välj tre vardagliga föremål som du vrider eller vevar, till exempel ett dörrhandtag, en vattenkran, en cykelpedal, en skruvmejsel eller en kastrullkork. Mät med linjal eller tumstock avståndet från vridpunkten till den punkt där din hand griper. Uppskatta därefter kraften för varje föremål genom att tänka dig hur många kilo som skulle behöva hänga i greppunkten för att ge samma vridning, och räkna om den massan till kraft. Ställ upp föremålen i en tabell med momentarm, uppskattad kraft och beräknat moment. Rangordna dem efter moment och bedöm om rangordningen stämmer med vilket av dem som känns tyngst att vrida. Förklara avslutningsvis varför ett föremål med kort momentarm kan kännas tyngre att vrida än ett med lång, även när kraften är densamma.
