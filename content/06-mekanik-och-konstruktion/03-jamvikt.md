...
7. En balk är 4,0 m lång och vilar på stöd i båda ändarna, A och B. En last på 600 N placeras 1,0 m från stöd A. Beräkna R_A och R_B. Avgör innan du räknar vilket stöd som bör bära mest.
8. Gångbron är 6,0 m lång med stöd i ändarna. Egentyngden 3600 N verkar i brons mitt, och en barnvagn med tyngden 1200 N står 4,5 m från stöd A. Beräkna stödreaktionerna, och kontrollera svaret genom att räkna momentsumman kring det andra stödet.
9. En byggnadsställnings bärbalk är 8,0 m lång och vilar på stöd i ändarna. Två laster verkar nedåt: 2000 N på 2,0 m från stöd A och 3000 N på 6,0 m från stöd A. Beräkna stödreaktionerna.
10. En mobilkrans egen tyngd är 40 000 N och verkar 2,0 m på den stabila sidan om det kritiska stödbenet. Hur stor last får hänga 10 m ut på bommen innan kranen står på gränsen till att välta?
