...
Gångbron är 6,0 m lång mellan stöden A och B. En cyklist med cykel, tillsammans 900 N, står stilla 2,0 m från stöd A. För att isolera själva metoden försummas brons egen tyngd tills vidare, så att bara den nyttiga lasten och de två stödreaktionerna finns med. Den frilagda bron har då tre yttre krafter: cyklistens tyngd nedåt och stödreaktionerna R_A och R_B uppåt.
...
1. **Ojämnt placerad last.** En balk är 4,0 m lång och vilar på stöd i båda ändarna, A och B. En last på 600 N placeras 1,0 m från stöd A. Beräkna R_A och R_B. Avgör innan du räknar vilket stöd som bör bära mest.
2. **Vem bär vad?** En byggnadsställnings bärbalk är 8,0 m lång och vilar på stöd i ändarna. Två laster verkar nedåt: 2000 N på 2,0 m från stöd A och 3000 N på 6,0 m från stöd A. Beräkna stödreaktionerna.
3. **Brons egen tyngd.** Gångbron är 6,0 m lång med stöd i ändarna. Egentyngden 3600 N verkar i brons mitt, och en barnvagn med tyngden 1200 N står 4,5 m från stöd A. Beräkna stödreaktionerna, och kontrollera svaret genom att räkna momentsumman kring det andra stödet.
4. **Vältgränsen.** En mobilkrans egen tyngd är 40 000 N och verkar 2,0 m på den stabila sidan om det kritiska stödbenet. Hur stor last får hänga 10 m ut på bommen innan kranen står på gränsen till att välta?
5. **När lasten rör sig.** En travers i en verkstad har en bärbalk som spänner 12,0 m mellan stöden A och B. Balkens egentyngd är 8000 N och verkar i mitten. En lyftvagn med last, tillsammans 15 000 N, står 3,0 m från stöd A. Beräkna stödreaktionerna och kontrollera svaret kring det andra stödet. Bestäm därefter var lyftvagnen ska stå för att de båda stöden ska bära lika mycket, och beräkna den största reaktionskraft stöd A någonsin kan utsättas för när vagnen körs längs hela balken. Bedöm om det värdet är rimligt i förhållande till den totala lasten på balken, och förklara vilket av stöden du skulle kontrollera först vid en besiktning.
6. **Stången som bär.** Välj en garderobsstång som vilar i två fästen, eller ett annat föremål som bärs upp av två stöd och som du kan väga och mäta. Mät stångens längd och avståndet mellan fästena. Väg eller uppskatta tyngden på det som hänger på stången och notera var på stången varje sak hänger. Rita stången med fästena som stöd och lasterna utsatta på sina platser, och beräkna hur stor del av lasten varje fäste bär. Flytta sedan den tyngsta lasten till stångens ena ände och räkna om. Bedöm vilket av fästena som är mest belastat i vartdera fallet, och avgör var på stången du skulle hänga det tyngsta om du fick välja fritt.
