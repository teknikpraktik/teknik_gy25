...
3. Skriv teori, figurplatshållare, delavsnitt (H3) vid behov och en avslutande EN samlad sektion instuderingsfrågor enligt 03 + 05 (inget Begrepp-block, inga praktiska uppgifter i avsnittet). Ta bort platshållarkommentaren.
...
- Avsnittet avslutas med EN samlad sektion instuderingsfrågor (inget fast antal), som täcker alla dess lärandemål och delavsnitt. Inget synligt Begrepp-block per avsnitt; praktiska uppgifter samlas i kapitlets uppgiftsbank. Varje kapitel avslutas med tre H2-avsnitt utan `learningGoals` — sammanfattning, begrepp, uppgiftsbank (`type: kapitelsammanfattning`/`begreppsovning`/`uppgiftsbank`) — listade direkt i 06-bokstruktur.md som kapitlets tre sista avsnitt, inte i något separat manifest.
