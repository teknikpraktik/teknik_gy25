...
**Filer.** Skapa avsnittsfilerna för de tre sista posterna i kapitlets del av 06-bokstruktur.md: `<NN>-sammanfattning.md` (`type: kapitelsammanfattning`), `<NN>-begrepp.md` (`type: begreppsovning`) och `<NN>-praktiska-uppgifter-och-projekt.md` (`type: uppgiftsbank`), i den ordningen. 06 styr existens och ordning — det finns inget separat manifest.
